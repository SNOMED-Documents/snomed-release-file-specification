...
{% hint style="info" %}
The associations shown on the page are the results of changes that occured between July 2018 and July 2019. For documentation file associations before these changes please refer to [Associations Between Release Files Prior to July 2018](https://github.com/SNOMED-Documents/snomed-release-file-specification/blob/main/4%20component-release-files-specification/broken-reference/README.md).
{% endhint %}
