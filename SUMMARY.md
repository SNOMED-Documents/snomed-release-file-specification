...
* [Reference Set Release Files Specification](<5 reference-set-release-files-specification/README.md>)
  ...
  * [Reference Set Types](<5 reference-set-release-files-specification/5.2 reference-set-types/README.md>)
    ...
    * [Map Reference Sets](<5 reference-set-release-files-specification/5.2 reference-set-types/5.2.3 map-reference-sets/README.md>)
      * [5.2.3.1-simple-map-from-snomed-ct-reference-set](5-reference-set-release-files-specification/5.2-reference-set-types/5.2.3-map-reference-sets/5.2.3.1-simple-map-from-snomed-ct-reference-set.md)
