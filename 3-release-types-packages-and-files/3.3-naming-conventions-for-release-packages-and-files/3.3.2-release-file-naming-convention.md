...
The basic pattern for [SNOMED CT release file](https://confluence.ihtsdotools.org/display/DOCGLOSS/SNOMED+CT+release+file) names consists of five elements, each separated by an underscore (" **\_** ") and followed by a full stop (" **.** ") and a file extension:\
\[code]\
