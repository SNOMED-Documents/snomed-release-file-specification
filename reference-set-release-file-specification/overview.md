...
* [5.1.1-basic-reference-set-member-file-format.md](5.1.1-basic-reference-set-member-file-format.md "mention")
* [5.2 reference-set-types](<../5 reference-set-release-files-specification/5.2 reference-set-types/> "mention")
